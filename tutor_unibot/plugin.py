...
config = {
    'defaults': {
        'UNIBOT_FRONTEND_PLATFORM_NPM_DEPENDENCY_URL': (
            'git+https://github.com/intela-bot/unibot-fe-platform.git.git#release/palm'
        ),
        'EDX_UNIBOT_PIP_DEPENDENCY_URL': (
            'git+https://github.com/intela-bot/edx-unibot.git@release/palm#egg=uni_bot'
        ),
        'EDX_UNIBOT_BRANCH': 'release/palm',
