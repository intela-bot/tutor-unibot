...
config = {
    'defaults': {
        'UNIBOT_FRONTEND_PLATFORM_NPM_DEPENDENCY_URL': (
            'git+https://github.com/intela-bot/unibot-fe-platform.git#release/redwood'
        ),
        'EDX_UNIBOT_PIP_DEPENDENCY_URL': (
            'git+https://github.com/intela-bot/edx-unibot.git@release/redwood#egg=uni_bot'
        ),
        'EDX_UNIBOT_BRANCH': 'main',
        'EDX_UNIBOT_VCS_URL': 'https://github.com/intela-bot/edx-unibot.git',
