...
![UNI Bot Plugin Demo](../assets/UNI%20bot%20Plugin%20(demo).gif)
...
![UNI Bot Plugin Presentation](../assets/UNI%20bot%20plugin%20presentation%20_%20v2.gif)
...
1. Download the installation script:
   ```bash
   wget https://raw.githubusercontent.com/intela-bot/tutor-unibot/release/redwood/unibot_install.sh && chmod +x unibot_install.sh
   ```
